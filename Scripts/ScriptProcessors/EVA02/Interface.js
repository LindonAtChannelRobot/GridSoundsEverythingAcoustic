...
TheSamplers[3].asSampler().loadSampleMap("12 STRING 1");
...
inline function onEnvelopeLaunchControl(component, value)
{
...
Content.getComponent("EnvelopeLaunch").setControlCallback(onEnvelopeLaunchControl);
